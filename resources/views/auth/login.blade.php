                ...
                <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                    ...
                    <div class="mt-12">
                        <form method="POST" action="{{ url('login') }}">
                            @csrf
                            <div>
                                <div class="text-sm font-bold text-gray-700 tracking-wide" for="email" :value="__('Email')">Email Address</div>
                                <input id="email" type="email" name="email" :value="old('email')" required autofocus autocomplete="" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" placeholder="mike@gmail.com">
                            </div>
                            <div class="mt-8">
