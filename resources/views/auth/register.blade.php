    ...
    <body class>
                ...
                <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                    ...
                    <div class="mt-12">
                        <form method="POST" action="{{ url('register') }}">
                            @csrf
                            <div>
                                <div class="text-sm font-bold text-gray-700 tracking-wide" for="name" :value="__('Name')">Name</div>
                                <input id="name" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" placeholder="jokowi">
                                @error('name')
                            ...
                            <div class="mt-5">
                                <div class="text-sm font-bold text-gray-700 tracking-wide" for="email" :value="__('Email')">E-mail Address</div>
                                <input id="email" type="text" name="email" :value="old('email')" required autofocus autocomplete="" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" placeholder="jokowi@mail.com">
                                @error('email')
                                <span class="pl-1 text-xs text-red-600 text-bold">
                                    {{$message}}
                                </span>
                            ...
                            <div class="mt-5">
                                ...
                                type="password"
                                name="password"
                                required autocomplete="current-password" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" placeholder="Enter your password">
                                @error('password')
                                <span class="pl-1 text-xs text-red-600 text-bold">
                                    {{$message}}
                                </span>
                            ...
                            <div class="mt-5">
                                <div class="flex justify-between items-center">
                                    <div class="text-sm font-bold text-gray-700 tracking-wide" for="password_confirmation" :value="__('Confirm Password')">
                                        Confirm Password
                                    </div>
                                </div>
                                <input id="password_confirmation"
                                type="password"
                                name="password_confirmation" required autocomplete="new-password" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" placeholder="Confirm your password">
                        ...
                        <div class="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                            Already registered ? <a class="cursor-pointer text-indigo-600 hover:text-indigo-800" href="{{route('login')}}">Sign in</a>
                        </div>
                    </div>
                </div>
            </div>
      ...
      <div class="REMOVE-THIS-ELEMENT-IF-YOU-ARE-USING-THIS-PAGE hidden treact-popup fixed inset-0 flex items-center justify-center" style="background-color: rgba(0,0,0,0.3);">
        <div class="max-w-lg p-8 sm:pb-4 bg-white rounded shadow-lg text-center sm:text-left">
          ...
          <div class="mt-5 pt-8 sm:pt-4 border-t -mx-8 px-8 flex flex-col sm:flex-row justify-end leading-relaxed">
