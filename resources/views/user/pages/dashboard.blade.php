...
<head>
    ...
    <!-- icon -->
    <link href="{{asset('users/assets/css/materialdesignicons.min.css')}}" rel="stylesheet" type="text/css" />
...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-white fixed-top navbar-custom sticky sticky-dark" id="main-menu">
            <div class="container">
                ...
                <a class="navbar-brand logo text-uppercase" href="index-1.html">
                    <img src="{{asset('users/assets/images/logo-dark.png')}}" alt="" height="24" />
                </a>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    <p class="home-heading-title">Simple, Easy Web Hosting</p>

                    <h1 class="home-title mt-3">Best Domain Hosting Provider For Your Business</h1>

                    <p class="home-desc text-muted mt-3">Etiam sed.Interdum consequat proin vestibulum class a euismod
                        mus
                        luctus quam amet, constur adipisicing eli.</p>


                    <form class="mt-5 home-form rounded">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-0">
                                    <input type="text" class="form-control" placeholder="Enter Your Domain Name">
                                </div>
                            </div>
                            <!--end col-->
                            ...
                            <div class="col-md-3">
                                <div class="form-group home-button">
                                    <input type="submit" id="search" name="search" class="btn btn-primary w-100"
                                        value="Search Now">
                                </div>
                            </div>
                            <!--end col-->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="title-box text-center">
                        <h6 class="title-sub-title mb-0 text-primary">Best Services</h6>
                        <h3 class="title-heading mt-3">Awesome customer service with our tools</h3>
                    </div>
                </div>
            </div>
    ...
    <section class="section bg-light overflow-hidden" id="features">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                  <div class="features-1 mt-4">
                      <img src="{{asset('users/assets/images/features/img-1.png')}}" alt="">
                  </div>
                </div>
            ...
            <div class="row mt-5 pt-5 align-items-center">
                <div class="col-lg-6">
                    <div class="mt-4">
                        <h3 class="w-75">We are trusted by <span class="text-primary">580+</span> big small business Destrin</h3>
                ...
                <div class="col-lg-6">
                    <div class="features-2 mt-4">
                        <img src="{{asset('users/assets/images/features/img-2.png')}}" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    ...
                    <div class="title-box text-center">
                        <h6 class="title-sub-title mb-0 text-primary">Our Testimonial</h6>
                        ...
                        <div class="carousel-indicators mt-5 pt-4">
                            ...
                            <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0"
                                ...
                                <div class="d-flex p-2">
                                    <img src="{{asset('images/users/img-1.jpg')}}" alt=""
                            ...
                            <button type="button" data-bs-target="#carouselExampleIndicators" class="text-start"
                                ...
                                <div class="d-flex p-2">
                                    <img src="{{asset('images/users/img-2.jpg')}}" alt=""
                                        class=" testi-img img-fluid rounded-circle">
                            ...
                            <button type="button" data-bs-target="#carouselExampleIndicators" class="text-start"
                                ...
                                <div class="d-flex p-2">
                                    <img src="{{asset('images/users/img-3.jpg')}}" alt=""
                                        class=" testi-img img-fluid rounded-circle">
    ...
    <script src="{{asset('users/assets/js/smooth-scroll.polyfills.min.js')}}"></script>
    <script src="{{asset('users/assets/js/gumshoe.polyfills.min.js')}}"></script>
    <!-- unicons icon -->
    <script src="{{asset('users/assets/js/unicons.js')}}"></script>
    <!-- Contact Form  -->
