                                ...
                                <div class="product-details-content quickview-content">
                                    ...
                                    <div class="pro-details-quality">
                                        <div class="pro-details-cart col-lg d-flex">
                                            <form action="{{ url('/user/add-to-cart/' . $item->id . '') }}"
                                                enctype="multipart/form-data" method="POST">
                                                @csrf
                                                @method('post')
                                                <div class="d-flex">
                                                    <div>
                                                        <input class="form-control col-sm" type="number"
                                                            name="jumlah_order" placeholder="jumlah order" />
                                    ...
                                    <div class="payment-img">
                                        <a href="#"><img src="{{ asset('users/assets/images/icons/payment.png') }}"
                                                alt=""></a>
                                    </div>
                                </div>
                            </div>
