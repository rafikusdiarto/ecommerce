            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="shop-bottom-area">
                                                ...
                                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-xs-6 mb-30px">
                                                    ...
                                                    <div class="product h-100">
                                                                ...
                                                                @if ($item->quantity == 0)
                                                                    <div>
                                                                        <img src="{{asset($item->product_img) }}"
                                                                            style="filter:blur(2px)" alt="Product" />
                                                                        <h2 class="text-danger alert alert-warning"
                                                                            style="position: absolute;top: 0;
                                                            left: 0;z-index:3">
                                                                            SOLD OUT</h2>
                                                                        <img class="hover-image"
                                                                            src="{{asset($item->product_img) }}"
                                                                            style="filter:blur(2px)" alt="Product" />

                                                                    </div>
                                                                @else
                                                                    <img src="{{asset($item->product_img) }}" alt="Product" />
                                                                    <img class="hover-image" src="{{asset($item->product_img) }}"
                                                                        alt="Product" />
                                                                @endif
                                                            </a>
                                                        </div>
                                                        <div class="content">
                                                            ...
                                                            <h5 class="title">
                                                                <a href="{{ route('singleproduct', $item->id) }}">{{ $item->product_name }}
                                                                </a>
                                                            </h5>
                                                            <span class="price">
                                                    ...
                                                    <button class="action wishlist" title="Wishlist" data-bs-toggle="modal" data-bs-target="#exampleModal-Wishlist"><i
                                                        class="pe-7s-like"></i></button> --}}
                                                            ...
                                                            <button class="action quickview" data-link-action="quickview"
                                                                ...
                                                                data-bs-target="#modalProduct{{ $item->id }}"><i
                                                    ...
                                                    <div class="col-md-7 col-lg-7 col-xl-8">
                                                        <div class="content-desc-wrap">
                                                            ...
                                                            <div class="box-inner">
                                                                ...
                                                                <div class="actions">
                                                                    <form
                                                                        action="{{ url('/user/add-to-cart/' . $item->id . '') }}"
                                                                        enctype="multipart/form-data" method="POST">
                                                                        @csrf
                                                                        @method('post')
                                                                        <input class="form-control col-sm" type="hidden"
                                                                            name="jumlah_order" min="1"
                                                                            value="1" placeholder="jumlah order" />
                                                                        <button title="Add To Cart"
                                                                            class="action add-to-cart me-2"
                                                                            type="submit"><i
                                                                                class="pe-7s-shopbag"></i></button>
                                                                    </form>
                        ...
                        @foreach ($getCategory as $item)
                            <div class="modal modal-2 fade" id="modalProduct{{ $item->id }}" tabindex="-1"
                                role="dialog">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"> <i class="pe-7s-close"></i></button>
                                            <div class="row">
                                                        ...
                                                        <div class="swiper-wrapper">
                                                            <div class="swiper-slide">
                                                                <img class="img-responsive m-auto"
                                                                    src="{{ asset($item->product_img) }}" alt="">
                                                            </div>
                                                            {{-- <div class="swiper-slide">
                                                    ...
                                                    <div class="product-details-content quickview-content">
                                                        ...
                                                        <div
                                                            ...
                                                            <ul class="d-flex">
                                                                <li>
                                                                    <a
                                                                        href="#">{{ $item->product_category_name }}</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        <div
                                                        ...
                                                        <div class="payment-img">
                                                            <a href="#"><img
                                                                    src="{{ asset('users/assets/images/icons/payment.png') }}"
                                                                    alt=""></a>
                                                        </div>
                                                    </div>
                                                </div>
