                ...
                <div class="col-12">
                    <div class="contact-info">
                        <div class="single-contact">
                            <div class="icon-box">
                                <img src="{{asset('users/assets/images/icons/contact-1.png')}}" alt="">
                            </div>
                            <div class="info-box">
                        ...
                        <div class="single-contact">
                            <div class="icon-box">
                                <img src="{{asset('users/assets/images/icons/contact-2.png')}}" alt="">
                            </div>
                            <div class="info-box">
                        ...
                        <div class="single-contact m-0">
                            <div class="icon-box">
                                <img src="{{asset('users/assets/images/icons/contact-3.png')}}" alt="">
                            </div>
                            <div class="info-box">
